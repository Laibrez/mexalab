      ...
      <div className="w-[95%] max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 mb-16">
          ...
          <div className="mt-12 text-center">
            <a href="https://wa.me/525584984243" target="_blank" rel="noopener noreferrer" className="inline-flex items-center p-4 sm:p-5 bg-[#25D366] rounded-2xl text-white hover:bg-[#128C7E] transition-colors cursor-pointer shadow-lg w-full sm:w-auto justify-center break-words">
              <svg viewBox="0 0 24 24" className="w-6 h-6 lg:w-8 lg:h-8 mr-3 flex-shrink-0 fill-current" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="font-bold text-base sm:text-xl truncate">Contáctanos por WhatsApp</span>
            </a>
          </div>
        </div>
